...
def normal_ppf(p: float) -> float:
    ...
    Needed to run a sportsbook line backwards: a book offering a team at -3 with a 54%
    de-vigged cover probability is telling you its expected margin is a bit more than 3,
    and this is how you recover that number.

    Accurate to about 1.15e-9 across the range, which is far beyond what a betting line
    resolves to.
    """
    if p <= 0.0:
        return -float("inf")
